...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        label .hint { font-weight: 400; color: #94a3b8; margin-left: 4px; }
        ...
        .radio-card-content .icon { font-size: 24px; margin-bottom: 8px; }
        .radio-card-content .title { font-weight: 600; font-size: 14px; }
        .radio-card-content .desc { font-size: 12px; color: #64748b; margin-top: 4px; }
        ...
        /* Puzzle upload area */
        .puzzle-upload { display: none; margin-top: 16px; }
        .puzzle-upload.show { display: block; }
